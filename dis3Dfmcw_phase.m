...
%基本参数设置
   ...
   % figure;plot(ypos,zpos,"r.-");title("Y-Z平面坐标变化");xlabel("Y轴");ylabel("Z轴");axis equal;
    ...
    %subplot(2,2,1);
    %plot(xpos,ypos,"r.-");title("X-Y平面坐标变化");xlabel("X轴");ylabel("Y轴");axis equal;
    %subplot(2,2,1);
    %plot(xpos,ypos,".-");title("X-Y平面坐标变化");xlabel("X轴");ylabel("Y轴");axis equal;
    %subplot(2,2,2);
    %plot(xpos,zpos,".-");title("X-Z平面坐标变化");xlabel("X轴");ylabel("Z轴");axis equal;
    %subplot(2,2,3);
    %plot(ypos,zpos,".-");title("Y-Z平面坐标变化");xlabel("Y轴");ylabel("Z轴");axis equal;
    %subplot(2,2,4);
    %plot3(xpos,ypos,zpos,".-");axis equal;
end